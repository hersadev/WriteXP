...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    description: 'Repasa por primera vez un ejercicio que se te resistió.',
    sigil: '↻',
    xp: 25,
    check: (p) => p.stats.reviewsDone >= 1,
  },
  {
    id: 'review-25',
    title: 'Memoria de escriba',
    description: 'Recuerda 25 repasos a la primera.',
    sigil: '🧠',
    xp: 110,
    check: (p) => p.stats.reviewsPerfect >= 25,
  },
  {
    id: 'review-graduated-10',
    title: 'Nada se queda atrás',
    description: 'Saca 10 ejercicios de la cola de repaso: acertados hasta el último escalón.',
    sigil: '🗝️',
    xp: 160,
    check: (p) => p.stats.reviewsGraduated >= 10,
  },
  {
    id: 'perfectionist',
    title: 'Sin tachones',
